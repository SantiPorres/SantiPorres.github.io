    ...
    <div class="flex justify-between w-full px-4 py-1.5 lg:px-8 max-w-7xl mx-auto">
      <div class="flex gap-2 items-center">
        <a v-for="link in externalLinks" :href="link.url" target="_blank"
          :class="`hover:bg-[#fff] hover:text-black transition-colors duration-300 text-center`"
