<template>
  <section class="bg-gray-700 py-20 px-2 lg:px-8 flex flex-col gap-6" id="contact">
    <div class="flex flex-col">
      <h1 class="text-4xl font-bold text-white w-full text-center">{{ $t('contact.title') }}</h1>
      <p class="text-gray-300/70 text-center">{{ $t('contact.description') }}</p>
    </div>
